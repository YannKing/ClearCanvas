...
namespace ClearCanvas.ImageViewer.Graphics
{
	...
	/// </summary>
	[Cloneable]
	public class SecondaryImageGraphic
		: ImageGraphic,
		  IVoiLutInstaller,
		  IColorMapInstaller,
		  ...
		  ILutPipelineProvider
	{
		...
		/// </para>
		/// </remarks>
		public SecondaryImageGraphic(int rows, int columns)
		...
		/// Cloning constructor.
		/// </summary>
		protected SecondaryImageGraphic(SecondaryImageGraphic source, ICloningContext context)
			: base(source, context)
		{
