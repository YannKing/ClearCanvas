...
namespace ClearCanvas.ImageViewer
{
    ...
    /// 定义在<see cref =“ITile”/>中呈现给用户的最终图像。
    /// </summary>
    /// <remarks>
    /// <para>
    /// <see cref =“IPresentationImage”/>可以被认为是“场景”。
     ///由许多部分组成，无论是图像，线条，文本等等
     ///在<see cref =“Tile”/>中呈现给用户的图像。
     /// </ para>
     /// <para>
     ///你不应该直接实现<see cref =“IPresentationImage”/>。
     ///相反，子类<see cref =“PresentationImage”/>。
    /// </para>
    /// </remarks>
