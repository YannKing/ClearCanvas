...
namespace ClearCanvas.ImageViewer.Volume.Mpr {
    ...
    public class SR {
        ...
        /// <summary>
        ///   查找类似 文件不是一个有效的、受支持的 dicom 映像 sop 实例。{0} 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 切片间距必须大于或等于 0.5, 并且小于或等于10。 的本地化字符串。
        /// </summary>
