...
namespace ClearCanvas.ImageViewer.StudyFinders.Remote {
    ...
    public class SR {
        ...
        /// <summary>
        ///   查找类似 无法在检查中的治疗方式标记中执行多个通配符查询。 的本地化字符串。
        /// </summary>
