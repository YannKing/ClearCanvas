...
namespace ClearCanvas.Desktop.Applets.WebBrowser
{
    ...
    public class WebBrowserComponent : ApplicationComponent
    {
        ...
        public override void Start()
        {
            ...
            //实例化使用WebBrowserToolExtensionPoint属性标记的所有工具（例如LaunchGoogleTool）
