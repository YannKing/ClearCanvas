...
{
    /// <summary>使用指定的操作标识符和路径提示声明菜单按钮操作。 </summary>
    public class MenuActionAttribute : ClickActionAttribute
    {
        ...
        /// 
        /// <param name="clickHandler">单击按钮时将调用的方法的名称。
        /// Name of the method that will be invoked when the button is clicked.</param>
        public MenuActionAttribute(string actionID, string pathHint, string clickHandler) : base(actionID, pathHint, clickHandler)
        {
        }
