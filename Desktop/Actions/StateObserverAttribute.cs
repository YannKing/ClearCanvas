...
namespace ClearCanvas.Desktop.Actions
{
    ...
    public abstract class StateObserverAttribute : ActionDecoratorAttribute
    {
        ...
        /// <param name="actionID">行动的独特标识。
        /// The unique identifer of the action.
        /// </param>
        /// <param name="observedProperty">要绑定的属性的名称。
        /// The name of the property to bind to.</param>
        /// <param name="observedChangeEvent">要绑定到的事件的名称通知订阅者属性值的更改。
        /// The name of the event to bind to that notifies subscribers of changes in the property value.</param>
        protected StateObserverAttribute(string actionID, string observedProperty, string observedChangeEvent): base(actionID)
        {
