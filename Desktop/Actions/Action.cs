...
namespace ClearCanvas.Desktop.Actions
{
	...
	public abstract class Action : IAction
	{
        ...
        /// <summary>
        /// 设置<see cref ="ISpecification"/>进行测试以确定是否当前用户具有足够的权限来访问该操作。
        /// 
        ...
        /// </summary>
        /// <remarks>
        /// 当一个动作允许性是一个布尔函数时，这个重载很有用多个权威令牌。使用<see cref ="PrincipalPermissionSpecification"/>，在
        /// 与<see cref ="AndSpecification"/>和<see cref ="OrSpecification"/>类组合
        /// 建立一个允许的复杂规范。
        /// 
