...
namespace ClearCanvas.Dicom
{
    ...
    /// 此类表示DICOM Part 10格式文件。 该类继承了AbstractMessage类。 该类包含
    /// <查看cref =“DicomAttributeCollection”/> Meta Info（组0x0002属性）和数据集的实例。
    /// </para>
    /// </remarks>
    public class DicomFile : DicomMessageBase
	{
        ...
        /// 从现有的MetaInfo和DataSet创建DicomFile实例。
        /// </summary>
        ...
        ///注意：如果文件中不包含DICM编码，则例程将采用
        ///该文件不是Part 10格式文件，而是编码为DataSet
        ///将传输语法设置为Implicit VR Little Endian。
        /// </remarks>
