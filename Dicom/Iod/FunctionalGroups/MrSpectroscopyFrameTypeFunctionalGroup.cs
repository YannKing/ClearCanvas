...
namespace ClearCanvas.Dicom.Iod.FunctionalGroups
{
    ...
    public class MrSpectroscopyFrameTypeFunctionalGroup : FunctionalGroupMacro
    {
        ...
        public MrSpectroscopyFrameTypeFunctionalGroup(DicomSequenceItem dicomSequenceItem) : base(dicomSequenceItem) { }
    ...
    public class MrSpectroscopyFrameTypeSequenceItem : SequenceIodBase
    {
        ...
        /// </summary>
        /// <param name="dicomSequenceItem">The DICOM sequence item.</param>
        public MrSpectroscopyFrameTypeSequenceItem(DicomSequenceItem dicomSequenceItem) : base(dicomSequenceItem) { }
