...
{
    //TODO: empty class - just return an object?  空类 - 只返回一个对象？

    /// <summary>编解码器参数的抽象基类。 </summary>
    public abstract class DicomCodecParameters
    {
        ...
        /// <summary>指定是否应将调色板颜色图像转换为RGB以进行压缩。 </summary>
        public bool ConvertPaletteToRGB { get; set; }

        #endregion
    }

    /// <summary> Interface for Dicom Compressor/Decompressors.  Dicom压缩器/解压缩器的接口。</summary>
    public interface IDicomCodec
    {
        /// <summary>编解码器的名称 </summary>
        string Name { get; }
        /// <summary>
