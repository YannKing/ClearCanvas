...
namespace ClearCanvas.Dicom.Network {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   查找类似 远程应用程序不支持此检查的某些实例。有关详细信息, 请参阅日志。 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 由于缺少 dicom 属性, 发生了故障。 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 由于远程应用程序无法到达您的计算机, 可能是由于配置错误, 检索失败。 的本地化字符串。
        /// </summary>
