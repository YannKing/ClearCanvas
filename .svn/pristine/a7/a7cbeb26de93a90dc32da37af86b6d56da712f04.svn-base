...
namespace ClearCanvas.ImageViewer.Volumes
{
    ...
    public class CreateVolumeException : Exception
    {
        ...
        protected CreateVolumeException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class UnsupportedSourceImagesException : CreateVolumeException
    {
        ...
        protected UnsupportedSourceImagesException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class UnsupportedPixelFormatSourceImagesException : CreateVolumeException
    {
        ...
        protected UnsupportedPixelFormatSourceImagesException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }

    [Serializable]
    public class InconsistentRescaleFunctionTypeException : CreateVolumeException
    {
        public InconsistentRescaleFunctionTypeException() : base("Multiple types of rescale function outputs were found in the source frames. All the rescale functions of the source frames must output in the same units.") { }

        protected InconsistentRescaleFunctionTypeException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }

    [Serializable]
    public class InconsistentImageLateralityException : CreateVolumeException
    {
        public InconsistentImageLateralityException() : base("Multiple image lateralities were found in the source frames. All the source frames must be of the same anatomical laterality.") { }

        protected InconsistentImageLateralityException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class NullSourceSeriesException : CreateVolumeException
    {
        ...
        protected NullSourceSeriesException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class MultipleSourceSeriesException : CreateVolumeException
    {
        ...
        protected MultipleSourceSeriesException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class NullFrameOfReferenceException : CreateVolumeException
    {
        ...
        protected NullFrameOfReferenceException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class MultipleFramesOfReferenceException : CreateVolumeException
    {
        ...
        protected MultipleFramesOfReferenceException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class NullImageOrientationException : CreateVolumeException
    {
        ...
        protected NullImageOrientationException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class MultipleImageOrientationsException : CreateVolumeException
    {
        ...
        protected MultipleImageOrientationsException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class UnevenlySpacedFramesException : CreateVolumeException
    {
        ...
        protected UnevenlySpacedFramesException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class UncalibratedFramesException : CreateVolumeException
    {
        ...
        protected UncalibratedFramesException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class AnisotropicPixelAspectRatioException : CreateVolumeException
    {
        ...
        protected AnisotropicPixelAspectRatioException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
    ...
    public class UnsupportedGantryTiltAxisException : CreateVolumeException
    {
        ...
        protected UnsupportedGantryTiltAxisException(SerializationInfo info, StreamingContext context) : base(info, context) { }
    }
