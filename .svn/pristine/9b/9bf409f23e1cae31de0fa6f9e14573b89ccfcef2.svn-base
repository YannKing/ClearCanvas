...
namespace ClearCanvas.ImageViewer.StudyManagement
{
    ...
    /// ///请注意，不再需要从这个类派生; <see cref =“Sop”/>，<see cref =“ImageSop”/>
    ///和<see cref =“Frame”/>类现在只是简单的Bridge类（参见Bridge Design Pattern）
    ///到<see cref =“ISopDataSource”/>和<see cref =“ISopFrameData”/>。 见
    ///请参阅<see cref =“ISopDataSource”/>获取更多信息。
    /// </ para>
    /// <para>另外，有关“瞬态参考”和<see cref =“Sop”/> s的生命周期的更多信息，
    ///参见<see cref =“ISopReference”/>。
    /// </para>
    /// </remarks>
    public partial class ImageSop : Sop
	{
        ...
        /// one frame.
        /// /// DICOM区分常规图像SOP和多帧图像SOP。
        ///然而，ClearCanvas没有做出这种区分，因为它需要这样做
        ///写入两组客户端代码。 相反，考虑所有图像SOP
        ///是多帧的，常规图像是多帧的特殊情况
        ///带有一帧的图像。 可以假设所有图像至少包含
        ///一帧。
        /// </remarks>
