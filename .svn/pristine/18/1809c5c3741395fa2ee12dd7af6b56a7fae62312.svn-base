...
namespace ClearCanvas.Desktop.Explorer.View.WinForms
{
    ...
    public partial class ExplorerConfigurationComponentControl : ApplicationComponentUserControl
    {
        ...
        /// Constructor.
        /// </summary>
        public ExplorerConfigurationComponentControl(ExplorerConfigurationComponent component) : base(component)
        {
            ...
            #region 翻译控件上的文字 Yann 2019年1月9日 10:48:55

            _launchAtStartup.Text = $@"启动时启动";
            _launchAsGroupBox.Text = $@"启动为:";
            _launchAsWorkspace.Text = $@"工作区";
            _launchAsShelf.Text = $@"停靠窗口";
            label1.Text = $@"注意: 必须关闭资源管理器, 更改才能生效。";
            #endregion
