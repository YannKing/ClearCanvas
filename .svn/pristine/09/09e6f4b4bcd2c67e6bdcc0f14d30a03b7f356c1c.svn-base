...
namespace ClearCanvas.ImageViewer
{
	...
	/// </summary>
	[Cloneable]
	public class DicomSecondaryPresentationImage : SecondaryPresentationImage, IDicomPresentationImage, IDicomVoiLutsProvider
	{
		[CloneIgnore]
		...
		/// </remarks>
		public DicomSecondaryPresentationImage(Frame frame)
		...
		public DicomSecondaryPresentationImage(IFrameReference frameReference)
		...
		/// Cloning constructor.
		/// </summary>
		protected DicomSecondaryPresentationImage(DicomSecondaryPresentationImage source, ICloningContext context)
			: base(source, context)
		{
