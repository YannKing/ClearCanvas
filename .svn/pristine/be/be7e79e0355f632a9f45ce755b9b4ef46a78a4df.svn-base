...
namespace ClearCanvas.ImageViewer.Tools.Standard.ImageProperties {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   查找类似 一个数字，表示父系列中图像的采集顺序 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 患者的唯一标识符（例如，医疗记录编号（MRN）） 的本地化字符串。
        /// </summary>
