...
{
    /// <summary>提供静态帮助程序方法来记录审计日志中的事件。
    /// Provides static helper methods to records events in the audit log.
    /// </summary>
    public static class AuditHelper
    {
        /// <summary>使用DICOM Supplement 95中所述的格式将事件记录到审核日志中。
        ...
        /// <summary>根据DICOM补充95，在审计日志中生成（已接收）“查询”事件。
        /// Generates a (received) "Query" event in the audit log, according to DICOM Supplement 95.
        /// </summary>
        /// <param name="remoteAETitle">发出查询的应用程序实体。
        /// The application entity that issued the query.</param>
        /// 
        /// <param name="remoteHostName">发出查询的应用程序实体的主机名。
        /// The hostname of the application entity that issued the query.</param>
        /// 
        /// <param name="eventResult">操作的结果。
        /// The result of the operation.</param>
        /// 
        /// <param name="sopClassUid">正在接收的DICOM查询类型的SOP类Uid。
        /// The SOP Class Uid of the type of DICOM Query being received.</param>
        /// 
        /// <param name="query">收到包含DICOM查询的数据集。
        /// The dataset containing the DICOM query received.</param>
