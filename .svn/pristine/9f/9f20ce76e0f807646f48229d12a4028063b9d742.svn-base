...
namespace ClearCanvas.ImageViewer.Explorer.Local {
    ...
    public class SR {
        ...
        /// <summary>
        ///   查找类似 无法导入选定的项, 因为本地服务未运行。
        ///请确保 &quot;{0}&quot; 正在运行, 或与系统管理员联系以获得帮助。 的本地化字符串。
        /// </summary>
