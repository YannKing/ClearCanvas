...
namespace ClearCanvas.ImageViewer
{
    ...
    /// </summary>
    [Cloneable]
    public class SecondaryPresentationImage
        ...
        IColorMapProvider
    {
        ...
        /// </remarks>
        public SecondaryPresentationImage(int rows, int columns)
            : base(new SecondaryImageGraphic(rows, columns))
        {
            _constructor = 0;
            _rows = rows;
            _columns = columns;
        ...
        /// </remarks>
        public SecondaryPresentationImage(
            int rows,
            int columns,
            int bitsAllocated,
            int bitsStored,
            ...
            : base(new SecondaryImageGraphic(
                       rows,
                       columns,
                       bitsAllocated,
                       bitsStored,
        ...
        /// Cloning constructor.
        /// </summary>
        protected SecondaryPresentationImage(SecondaryPresentationImage source, ICloningContext context)
            : base(source, context)
        {
        ...
        /// </summary>
        public new SecondaryImageGraphic ImageGraphic
        {
            get { return (SecondaryImageGraphic)base.ImageGraphic; }
        }
