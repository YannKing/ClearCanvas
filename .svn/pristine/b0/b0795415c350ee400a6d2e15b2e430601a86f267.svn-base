...
{
	public class SecondarySoftcopyPresentationStateIod
	{
		private readonly IDicomAttributeProvider _dicomAttributeProvider;

		public SecondarySoftcopyPresentationStateIod() : this(new DicomAttributeCollection()) {}

		public SecondarySoftcopyPresentationStateIod(IDicomAttributeProvider provider)
		{
