...
namespace ClearCanvas.Desktop.Actions
{
    ...
    public class IconSetAttribute : ActionDecoratorAttribute
    {
        ...
        /// </summary>
        /// <remarks>不推荐使用图标方案来支持可扩展的应用程序GUI主题。
        ...
        [Obsolete("不推荐使用图标方案来支持可扩展的应用程序GUI主题" +
                  "The use of icon schemes has been deprecated in favour of extensible application GUI themes")]
        ...
        /// <param name="smallIcon">要以小分辨率使用的图标的资源名称(around 24 x 24).</param>
        /// <param name="mediumIcon">要以中等分辨率使用的图标的资源名称(around 48 x 48).</param>
        /// <param name="largeIcon">要在大分辨率下使用的图标的资源名称(around 64 x 64).</param>
        public IconSetAttribute(string actionId, string smallIcon, string mediumIcon, string largeIcon) : base(actionId)
        {
        ...
        public IconSetAttribute(string actionId, string icon) : base(actionId)
        {
