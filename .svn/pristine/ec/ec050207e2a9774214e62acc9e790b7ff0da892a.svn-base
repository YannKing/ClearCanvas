...
namespace ClearCanvas.Dicom.Network
{
        ...
        public override string ToString()
        {
            ...
            foreach (DicomPresContext pctx in _presContexts.Values)
            {
                ...
                else
                {
                    ...
                    {
                        sb.AppendFormat("  Transfer: {0}", (ts.DicomUid.Type == UidType.Unknown) ? ts.DicomUid.UID : ts.DicomUid.Description);
                        sb.AppendLine();
                    }
                }
            }
    ...
    {
        public ClientAssociationParameters(String callingAe, String calledAe, string hostname, int port) : base(callingAe, calledAe, null, null)
        {
            IPAddress addr;
        ...
        public ClientAssociationParameters(String callingAE, String calledAE, IPEndPoint remoteEndPoint) : base(callingAE, calledAE, null, remoteEndPoint)
        {
            RemotePort = remoteEndPoint.Port;
            RemoteHostname = remoteEndPoint.Address.ToString();
        }

        private ClientAssociationParameters(ClientAssociationParameters parameters) : base(parameters)
        {
        }
    ...
    {
        internal ServerAssociationParameters() : base(null, null, null, null) { }

        public ServerAssociationParameters(String calledAe, IPEndPoint localEndPoint) : base(null, calledAe, localEndPoint, null) { }
