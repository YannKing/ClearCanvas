...
{
    /// <summary>提供一组用于对集合执行功能样式操作的方法。</summary>
    public static class CollectionUtils
    {
        /// <summary> Delegate for use with <see cref="CollectionUtils.Reduce{TItem,TMemo}"/>. </summary>
        public delegate M ReduceDelegate<T, M>(T item, M memo);

        /// <summary>选择目标集合中与指定谓词匹配的所有项目，并返回它们作为指定类型的新集合。 </summary>
        /// <typeparam name="TItem">目标集合中的项目类型。</typeparam>
        /// <typeparam name="TResultCollection">要返回的集合类型。</typeparam>
        /// <param name="target">要运行的集合。</param>
        /// <param name="predicate">要测试的谓词。</param>
        ...
        /// <summary> 选择目标集合中与指定谓词匹配的所有项目。</summary>
        ...
        /// <summary>排除目标集合中与指定谓词匹配的所有项目，并返回其余项目作为指定类型的新集合。</summary>
        /// <typeparam name="TItem">The type of items in the target collection.</typeparam>
        ...
        /// <summary>如果目标集合中的任何项满足指定的谓词，则返回true。
        /// Returns true if any item in the target collection satisfies the specified predicate.
        /// </summary>
        ...
        /// <summary>如果目标集合中的所有项都满足指定的谓词，则返回true。
        ...
        /// <summary>返回目标集合中的第一个元素，如果集合为空，则返回null。
        ...
        /// <summary>返回目标集合中的第一个元素，如果集合为空，则返回指定的<paramref name ="defaultValue"/>。
        /// 
        ...
        /// <summary>返回目标集合中的最后一个元素，如果集合为空，则返回null。
        ...
        /// <summary>返回目标集合中的最后一个元素，如果集合为空，则返回指定的<paramref name ="defaultValue"/>。
        ...
        /// <remarks>
        /// <para>如果集合包含空值，则将它们视为小于任何其他值。
        /// If the collection contains nulls, they are treated as less than any other value.</para>
        /// </remarks>
        ...
        /// <summary>返回目标集合中的最小值，如果集合为空，则返回null。
        /// Returns the minimum value in the target collection, or null if the collection is empty.
        /// </summary>
        /// <remarks>
        /// <para>集合必须包含对象引用，而不是值类型。
        /// The collection must contain object references, not value types.</para>
        /// <para>如果集合包含空值，则将它们视为小于任何其他值。
        /// If the collection contains nulls, they are treated as less than any other value.</para>
        /// </remarks>
        public static TItem Min<TItem>(IEnumerable target) where TItem : class, IComparable<TItem>
        {
        ...
        /// If the collection contains nulls, they are treated as less than any other value.</para>
        /// </remarks>
        public static TItem Min<TItem>(IEnumerable<TItem> target) where TItem : class, IComparable<TItem>
        {
            return Min(target, null);
        }

        /// <summary>返回目标集合中的最大值，如果集合为空，则返回指定的<paramref name ="nullValue"/>。
        ...
        /// </remarks>
        public static TItem Max<TItem>(IEnumerable target) where TItem : class, IComparable<TItem>
        {
            return Max<TItem>(target, null);
        }

        /// <summary>返回目标集合中的最大值，如果集合为空，则返回null。
        /// Returns the maximum value in the target collection, or the null if the collection is empty.
        /// </summary>
        /// <remarks>
        /// <para>The collection must contain object references, not value types.</para>
        /// <para>If the collection contains nulls, they are treated as less than any other value.</para>
        /// </remarks>
        public static TItem Max<TItem>(IEnumerable<TItem> target) where TItem : class, IComparable<TItem>
        {
