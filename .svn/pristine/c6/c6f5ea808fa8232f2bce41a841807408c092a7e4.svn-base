...
namespace ClearCanvas.Desktop
{
    ...
    /// <summary>定义桌面工具的扩展点，每个桌面窗口实例化一次。</summary>
    /// <remarks>桌面工具归桌面窗口所有。每个桌面窗口都会实例化一次桌面工具。
    /// 扩展应该期望接收类型<see cref ="IDesktopToolContext"/>的工具上下文。
    /// 
    ...
    /// <summary>提供给扩展<see cref =“DesktopToolExtensionPoint”/>的工具的工具上下文界面。
    ...
    public class DesktopWindow : DesktopObject, IDesktopWindow
    {
        ...
        class AlertContext : IDesktopAlertContext
        {
            ...
            public int UnacknowledgedErrorWarningCount
            {
                get
                {
                    // count the number of un-acknowledged errors/warnings 计算未确认的错误/警告的数量
         ...
         : base(args)
        {
            ...
            // if no title supplied, create a default title 如果没有提供标题，则创建默认标题
        ...
        /// <summary>获取当前活动的工作空间，如果没有工作空间，则返回null。
        ...
        /// <summary>在此窗口前显示一个消息框。
        /// Shows a message box in front of this window.
        /// </summary>
        /// <param name="message">要在消息框中显示的消息。
        /// The message to show in the message box.</param>
        /// 
        /// <param name="buttons">要在消息框中显示的按钮。
        /// The buttons to display in the message box.</param>
        /// <returns>用户选择的按钮以关闭消息框。
        /// The button the user selected to dismiss the message box.</returns>
        ...
        /// The message to show in the message box.</param>
        /// 
        /// <param name="title">消息框的标题。
        /// The title of the message box.</param>
        /// 
        /// <param name="buttons">要在消息框中显示的按钮。
        /// The buttons to display in the message box.</param>
        /// 
        ...
        /// </summary>
        /// <param name="level">警报级别。
        /// The alert level.</param>
        /// <param name="message">要显示的消息。
        ...
        /// The message to display.</param>
        /// 
        /// <param name="linkText">要显示的链接文本。
        /// The link text to display.</param>
        /// 
        /// <param name="linkAction">要显示的链接操作。
        /// The link action to display.</param>
        /// 
        ...
        /// <summary>在此窗口前显示一个对话框。
        /// Shows a dialog box in front of this window.
        /// </summary>
        /// <param name="args">创建助手对象。
        /// Creation helper object.</param>
        /// 
        /// <returns>用户选择的按钮以关闭对话框。
        /// The button the user selected to dismiss the dialog.</returns>
        ...
        private static string DefaultBaseTitle
        {
            get
            {
                ...
                return string.IsNullOrEmpty(name) ? tagString : string.Format("{0}", tagString);
            }
        }
