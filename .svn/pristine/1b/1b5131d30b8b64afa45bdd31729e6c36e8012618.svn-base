...
{
    /// <summary>用于装饰操作的属性集的抽象基类一旦它被<see cref ="ActionInitiatorAttribute"/>声明。
    ...
    public abstract class ActionDecoratorAttribute : ActionAttribute
    {
        ...
        /// <param name="actionID">行动的独特标识。</param>
        protected ActionDecoratorAttribute(string actionID) : base(actionID)
        {
