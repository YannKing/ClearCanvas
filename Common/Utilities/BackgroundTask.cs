...
namespace ClearCanvas.Common.Utilities
{
    ...
    public sealed class BackgroundTask : IDisposable
    {
        ...
        /// 如果已调用<see cref =“RequestCancel”/>方法，并且请求处于挂起状态，则为True。
        /// </summary>
        ...
        /// 获取或设置后台任务的区域性。 如果为NULL，则不会修改区域性。
        /// </summary>
        ...
        /// 获取或设置资源管理器用于查找后台任务的特定于文化的资源的区域性。 如果为NULL，则不会修改区域性。
        /// </summary>
