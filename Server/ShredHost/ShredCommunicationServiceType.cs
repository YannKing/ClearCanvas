...
namespace ClearCanvas.Server.ShredHost
{
    public class ShredCommunicationServiceType : IShredCommunication
    {
        ...
        public void Pause()
        {
            ...
            XTrace.WriteLine($"{ _className}[{AppDomain.CurrentDomain.FriendlyName }] Pause invoked");
        }
        ...
        public void Stop()
        {
            ...
            XTrace.WriteLine($"{ _className}[{AppDomain.CurrentDomain.FriendlyName }] Stop invoked");
        ...
        public void Unpause()
        {
            ...
            XTrace.WriteLine($"{ _className}[{AppDomain.CurrentDomain.FriendlyName }] Unpause invoked");
        }
